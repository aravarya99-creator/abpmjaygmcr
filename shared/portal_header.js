...
.user-dropdown {
  ...
  box-shadow: 0 12px 36px rgba(0,0,0,0.22), 0 2px 8px rgba(0,0,0,0.08) !important;
            ...
            <div class="user-pill-container user-pill" style="position: relative; display: flex; align-items: center;">
              ...
              <div class="user-dropdown" id="userDD" onclick="event.stopPropagation();">
                ...
                <div id="phPortalSwitchMenu" style="display:none; background:#f8fafc; border-top:1px solid #e2e8f0; border-bottom:1px solid #e2e8f0; padding:4px 0;">
                  ...
                  <a href="ic_portal.html" style="display:flex;align-items:center;gap:8px;padding:7px 16px 7px 28px;font-size:11px;font-weight:700;color:#1e3a8a;text-decoration:none;">🩺 I/C AB-PMJAY</a>
